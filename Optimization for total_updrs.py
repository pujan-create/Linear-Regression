...
#plt.show() #uncomment this to see the figure
...
ax2.scatter(x = df['shimmer(apq11)'], y = df['total_updrs'])
...
ax4.set_xlabel("ppe")
ax4.set_ylabel("total_updrs")
#plt.show() #uncoment this to see the figure
...
plt.subplot(1,2,1)
plt.scatter(df["jitter(%)"], df["total_updrs"], color="green")
...
plt.subplot(1,2,2)
plt.scatter(df["logjitter(%)"], df["total_updrs"], color="red")
